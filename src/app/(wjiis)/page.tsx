...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="IJLSCL - International Journal of Legal Studies and Contemporary Law"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in legal studies, jurisprudence, and contemporary law."
        keywords={['legal studies', 'law journal', 'jurisprudence', 'research journal', 'academic publishing', 'IJLSCL', 'peer review']}
        ogImage="https://ijlscl.com/og-image.jpg"
        canonicalUrl="https://ijlscl.com"
      />
      <WebsiteSchema
        name="IJLSCL"
        url="https://ijlscl.com"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in legal studies, jurisprudence, and contemporary law."
        publisher="IJLSCL"
      />
      <OrganizationSchema
        name="IJLSCL"
        url="https://ijlscl.com"
        logo="https://ijlscl.com/ijlscl-logo.svg"
        description="IJLSCL - International Journal of Legal Studies and Contemporary Law"
        contactPoint={{
          email: "editor@ijlscl.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #4a235a 0%, #6b3d7a 100%)'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#c9a961'}}>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  ...
                  <span style={{color: '#c9a961'}}>Legal Studies and<br className="hidden md:block" />Contemporary Law</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#e8d4b8'}}>
                  A peer-reviewed international journal dedicated to publishing rigorous research in legal studies, jurisprudence, and contemporary law for a global audience.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    ...
                    onMouseEnter={e => (e.currentTarget.style.background='#b39450')}
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 max-w-lg" style={{borderTop: '1px solid rgba(255,255,255,0.2)'}}>
                  <div>
                    ...
                    <div className="text-sm font-medium" style={{color: '#c9a961'}}>Legal Articles</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">{stats.totalAuthors.toLocaleString()}+</div>
                    <div className="text-sm font-medium" style={{color: '#c9a961'}}>Global Scholars</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">15+</div>
                    <div className="text-sm font-medium" style={{color: '#c9a961'}}>Indexed In</div>
                  </div>
                </div>
              </div>
        ...
        {/* Why Choose Us */}
        <section className="py-16 border-y border-slate-200" style={{background: '#faf6f1'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-serif font-bold mb-4" style={{color: '#4a235a'}}>Journal Features</h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
                We are committed to the highest standards of academic publishing in legal studies.
              </p>
            </div>

            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: Globe, title: 'Global Reach', desc: 'Connecting legal scholars and researchers from over 80 countries.' },
                { icon: Shield, title: 'Rigorous Peer Review', desc: 'Double-blind review process ensuring quality and objectivity in legal scholarship.' },
                { icon: Zap, title: 'Rapid Publication', desc: 'Efficient processing with an average turnaround of 4-6 weeks.' },
                { icon: BookOpen, title: 'Open Access', desc: 'Free unrestricted access to all published legal research.' },
                { icon: Target, title: 'High Visibility', desc: 'Indexed in major academic databases for maximum legal citation.' },
                { icon: CheckCircle2, title: 'Ethical Standards', desc: 'Strict adherence to COPE guidelines for publication ethics.' }
              ].map((feature, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm" style={{border: '1px solid #e8d4b8', borderTop: '3px solid #c9a961'}}>
                  <feature.icon className="w-8 h-8 mb-4" style={{color: '#4a235a'}} />
                  <h3 className="text-lg font-bold mb-2" style={{color: '#4a235a'}}>{feature.title}</h3>
        ...
        {/* CTA */}
        <section className="py-16 text-white" style={{background: 'linear-gradient(135deg, #4a235a 0%, #6b3d7a 100%)'}}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-white">
              Submit Your Legal Research Today
            </h2>
            <p className="mb-8 text-lg" style={{color: '#e8d4b8'}}>
              Join our community of legal scholars and contribute to advancing contemporary law globally.
            </p>
